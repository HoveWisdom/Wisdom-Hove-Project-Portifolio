...
![Canvas App](assets/commonwealth-gbv/powerapps-canvas-01.png)
-->
*Screenshots of apps, dashboards, and SharePoint structures — to be added.*
...
<!-- Add screenshots here once available, for example:
![App Screenshot](assets/smart-crop/app-01.png)
-->
...
Screenshots are organised under the `assets/` folder. Place images there and embed them using the pattern shown below:
...
- **Name:** Wisdom Hove
- **GitHub:** [@HoveWisdom](https://github.com/HoveWisdom)

> To add an email address or LinkedIn URL, open an issue or pull request and I'll include a clean "Contact" section with a short "About" intro suitable for a GitHub profile.